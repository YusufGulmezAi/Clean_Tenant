...
public sealed class CatalogSeeder
{
    ...
    public async Task SeedCoreCatalogAsync(CancellationToken cancellationToken = default)
    {
        ...
        // SystemAdmin tam erişim alır (eski Developer'ın yerini devraldı).
        // TenantAdmin / CompanyAdmin'e seed ile izin ATANMAZ — boş başlar; izinlerini
        // SystemAdmin, Rol Yönetimi ekranından düzenler (karar 2026-05-24).
    ...
    /// <summary>
    /// SystemAdmin built-in rolüne katalogdaki TÜM permission'ları idempotent olarak
    /// atar. SystemAdmin "tam erişim" operatör rolüdür (eski Developer'ın yerini
    /// devraldı); yeni permission eklenince otomatik kazanır. TenantAdmin/CompanyAdmin
    /// izinleri kasıtlı boş bırakılır — SystemAdmin onları Rol Yönetimi ekranından
    /// düzenler (karar 2026-05-24).
    /// </summary>
    private async Task SeedSystemAdminPermissionsAsync(CancellationToken cancellationToken)
    {
        var systemAdminRole = await _db.Roles
            .AsNoTracking()
            .FirstOrDefaultAsync(r => r.NormalizedName == "SYSTEMADMIN" && r.Scope == ScopeLevel.System, cancellationToken);

        if (systemAdminRole is null)
        {
            _logger.LogWarning("SystemAdmin rolü bulunamadı; permission seed atlandı.");
            return;
        }
        ...
        {
            await _db.SaveChangesAsync(cancellationToken);
            _logger.LogInformation("SystemAdmin (tam erişim) permission seed: {Added} yeni atama yapıldı.", added);
        }
        else
        {
            _logger.LogInformation("SystemAdmin permission seed: değişiklik yok.");
        }
    }
    ...
    private static IEnumerable<ChartOfAccountsTemplate> GetChartOfAccountsTemplates()
    {
        ...
        [
            ...
            T("100.001",      "100",   "Merkez Kasa",                             Sub,  Dv,  Act, true,  false, true,  1010),
            T("100.001.001",  "100.001","Ana Kasa",                                Det,  Dv,  Act, true,  true,  true,  1011),
            T("101",         null,    "Alınan Çekler",                           Main, Dv,  Act, true,  false, true,  1020),
            T("101.001",      "101",   "Portföydeki Çekler",                      Sub,  Dv,  Act, true,  false, true,  1021),
            T("101.001.001",  "101.001","Portföydeki Çekler",                      Det,  Dv,  Act, true,  true,  true,  1022),
            ...
            T("108.001",      "108",   "Diğer Hazır Değerler",                    Sub,  Dv,  Act, false, false, true,  1051),
            T("108.001.001",  "108.001","Diğer Hazır Değerler",                    Det,  Dv,  Act, false, true,  true,  1052),
            ...
            T("120.001",      "120",   "Yurtiçi Alıcılar",                       Sub,  Dv,  Act, true,  false, true,  1201),
            T("120.001.001",  "120.001","Yurtiçi Alıcılar",                        Det,  Dv,  Act, true,  true,  true,  1202),
            T("121",         null,    "Alacak Senetleri",                        Main, Dv,  Act, true,  false, true,  1210),
            T("121.001",      "121",   "Alacak Senetleri",                        Sub,  Dv,  Act, true,  false, true,  1211),
            T("121.001.001",  "121.001","Alacak Senetleri",                        Det,  Dv,  Act, true,  true,  true,  1212),
            ...
            T("190.001",      "190",   "Devreden KDV",                            Sub,  Dv,  Act, true,  false, true,  1901),
            T("190.001.001",  "190.001","Devreden KDV",                            Det,  Dv,  Act, true,  true,  true,  1902),
            T("191",         null,    "İndirilecek KDV",                         Main, Dv,  Act, true,  false, true,  1910),
            T("191.001",      "191",   "İndirilecek KDV (%1)",                    Sub,  Dv,  Act, true,  false, true,  1911),
            T("191.001.001",  "191.001","İndirilecek KDV (%1)",                    Det,  Dv,  Act, true,  true,  true,  1912),
            T("191.010",      "191",   "İndirilecek KDV (%10)",                   Sub,  Dv,  Act, true,  false, true,  1913),
            T("191.010.001",  "191.010","İndirilecek KDV (%10)",                   Det,  Dv,  Act, true,  true,  true,  1914),
            T("191.020",      "191",   "İndirilecek KDV (%20)",                   Sub,  Dv,  Act, true,  false, true,  1915),
            T("191.020.001",  "191.020","İndirilecek KDV (%20)",                   Det,  Dv,  Act, true,  true,  true,  1916),
            ...
            T("193.001",      "193",   "Geçici Vergi",                            Sub,  Dv,  Act, true,  false, true,  1931),
            T("193.001.001",  "193.001","Geçici Vergi",                            Det,  Dv,  Act, true,  true,  true,  1932),
            ...
            T("250.001",      "250",   "Arazi ve Arsalar",                        Sub,  Dav, Act, false, false, false, 2501),
            T("250.001.001",  "250.001","Arazi ve Arsalar",                        Det,  Dav, Act, false, true,  false, 2502),
            ...
            T("252.001",      "252",   "Binalar",                                 Sub,  Dav, Act, true,  false, false, 2521),
            T("252.001.001",  "252.001","Binalar",                                 Det,  Dav, Act, true,  true,  false, 2522),
            ...
            T("255.001",      "255",   "Demirbaşlar ve Döşemeler",                Sub,  Dav, Act, true,  false, false, 2551),
            T("255.001.001",  "255.001","Demirbaşlar ve Döşemeler",                Det,  Dav, Act, true,  true,  false, 2552),
            ...
            T("257.001",      "257",   "Binalar Birikmiş Amortismanı (-)",        Sub,  Dav, Pas, true,  false, false, 2571),
            T("257.001.001",  "257.001","Binalar Birikmiş Amortismanı (-)",        Det,  Dav, Pas, true,  true,  false, 2572),
            ...
            T("300.001",      "300",   "Kısa Vadeli TL Krediler",                 Sub,  Kv,  Pas, true,  false, true,  3001),
            T("300.001.001",  "300.001","Kısa Vadeli TL Krediler",                 Det,  Kv,  Pas, true,  true,  true,  3002),
            ...
            T("320.001",      "320",   "Yurtiçi Satıcılar",                       Sub,  Kv,  Pas, true,  false, true,  3201),
            T("320.001.001",  "320.001","Yurtiçi Satıcılar",                       Det,  Kv,  Pas, true,  true,  true,  3202),
            T("321",         null,    "Borç Senetleri",                          Main, Kv,  Pas, true,  false, true,  3210),
            T("321.001",      "321",   "Borç Senetleri",                          Sub,  Kv,  Pas, true,  false, true,  3211),
            T("321.001.001",  "321.001","Borç Senetleri",                          Det,  Kv,  Pas, true,  true,  true,  3212),
            ...
            T("335.001",      "335",   "Ödenecek Ücretler",                       Sub,  Kv,  Pas, true,  false, true,  3351),
            T("335.001.001",  "335.001","Ödenecek Ücretler",                       Det,  Kv,  Pas, true,  true,  true,  3352),
            ...
            T("360.001",      "360",   "Ödenecek Gelir Vergisi Stopajı",          Sub,  Kv,  Pas, true,  false, true,  3601),
            T("360.001.001",  "360.001","Ödenecek Gelir Vergisi Stopajı",          Det,  Kv,  Pas, true,  true,  true,  3602),
            T("360.002",      "360",   "Ödenecek KDV",                            Sub,  Kv,  Pas, true,  false, true,  3603),
            T("360.002.001",  "360.002","Ödenecek KDV",                            Det,  Kv,  Pas, true,  true,  true,  3604),
            T("361",         null,    "Ödenecek Sosyal Güvenlik Kesintileri",    Main, Kv,  Pas, true,  false, true,  3610),
            T("361.001",      "361",   "Ödenecek SGK Primleri (İşçi)",            Sub,  Kv,  Pas, true,  false, true,  3611),
            T("361.001.001",  "361.001","Ödenecek SGK Primleri (İşçi)",            Det,  Kv,  Pas, true,  true,  true,  3612),
            T("361.002",      "361",   "Ödenecek SGK Primleri (İşveren)",         Sub,  Kv,  Pas, true,  false, true,  3613),
            T("361.002.001",  "361.002","Ödenecek SGK Primleri (İşveren)",         Det,  Kv,  Pas, true,  true,  true,  3614),
            ...
            T("391.001",      "391",   "Hesaplanan KDV (%1)",                     Sub,  Kv,  Pas, true,  false, true,  3911),
            T("391.001.001",  "391.001","Hesaplanan KDV (%1)",                     Det,  Kv,  Pas, true,  true,  true,  3912),
            T("391.010",      "391",   "Hesaplanan KDV (%10)",                    Sub,  Kv,  Pas, true,  false, true,  3913),
            T("391.010.001",  "391.010","Hesaplanan KDV (%10)",                    Det,  Kv,  Pas, true,  true,  true,  3914),
            T("391.020",      "391",   "Hesaplanan KDV (%20)",                    Sub,  Kv,  Pas, true,  false, true,  3915),
            T("391.020.001",  "391.020","Hesaplanan KDV (%20)",                    Det,  Kv,  Pas, true,  true,  true,  3916),
            ...
            T("500.001",      "500",   "Ödenmiş Sermaye",                         Sub,  Ok,  Pas, true,  false, false, 5001),
            T("500.001.001",  "500.001","Ödenmiş Sermaye",                         Det,  Ok,  Pas, true,  true,  false, 5002),
            ...
            T("570.001",      "570",   "Geçmiş Yıllar Kârları",                   Sub,  Ok,  Pas, true,  false, false, 5701),
            T("570.001.001",  "570.001","Geçmiş Yıllar Kârları",                   Det,  Ok,  Pas, true,  true,  false, 5702),
            ...
            T("590.001",      "590",   "Dönem Net Kârı",                          Sub,  Ok,  Pas, true,  false, false, 5901),
            T("590.001.001",  "590.001","Dönem Net Kârı",                          Det,  Ok,  Pas, true,  true,  false, 5902),
            T("591",         null,    "Dönem Net Zararı (-)",                    Main, Ok,  Act, true,  false, false, 5910),
            T("591.001",      "591",   "Dönem Net Zararı (-)",                    Sub,  Ok,  Act, true,  false, false, 5911),
            T("591.001.001",  "591.001","Dönem Net Zararı (-)",                    Det,  Ok,  Act, true,  true,  false, 5912),

            // 6. GELİR TABLOSU HESAPLARI
            T("600",         null,    "Yurtiçi Satışlar",                        Main, Gel, Pas, true,  false, false, 6000),
            T("600.001",      "600",   "Yurtiçi Satışlar",                        Sub,  Gel, Pas, true,  false, false, 6001),
            T("600.001.001",  "600.001","Yurtiçi Satışlar",                        Det,  Gel, Pas, true,  true,  false, 6002),
            ...
            T("621.001",      "621",   "Satılan Ticari Malların Maliyeti (-)",    Sub,  Gel, Act, true,  false, false, 6211),
            T("621.001.001",  "621.001","Satılan Ticari Malların Maliyeti (-)",    Det,  Gel, Act, true,  true,  false, 6212),
            ...
            T("632.001",      "632",   "Genel Yönetim Giderleri (-)",             Sub,  Gel, Act, true,  false, false, 6321),
            T("632.001.001",  "632.001","Genel Yönetim Giderleri (-)",             Det,  Gel, Act, true,  true,  false, 6322),
            ...
            T("646.001",      "646",   "Kambiyo Kârları",                         Sub,  Gel, Pas, true,  false, true,  6461),
            T("646.001.001",  "646.001","Kambiyo Kârları",                         Det,  Gel, Pas, true,  true,  true,  6462),
            ...
            T("656.001",      "656",   "Kambiyo Zararları (-)",                   Sub,  Gel, Act, true,  false, true,  6561),
            T("656.001.001",  "656.001","Kambiyo Zararları (-)",                   Det,  Gel, Act, true,  true,  true,  6562),
            ...
            T("660.001",      "660",   "Kısa Vadeli Banka Faizi (-)",             Sub,  Gel, Act, true,  false, true,  6601),
            T("660.001.001",  "660.001","Kısa Vadeli Banka Faizi (-)",             Det,  Gel, Act, true,  true,  true,  6602),
            ...
            T("690.001",      "690",   "Dönem Kârı veya Zararı",                 Sub,  Gel, AP,  true,  false, false, 6901),
            T("690.001.001",  "690.001","Dönem Kârı veya Zararı",                 Det,  Gel, AP,  true,  true,  false, 6902),
            ...
            T("698.001",      "698",   "Enflasyon Düzeltmesi Hesabı",            Sub,  Gel, AP,  true,  false, true,  6981),
            T("698.001.001",  "698.001","Enflasyon Düzeltmesi Hesabı",            Det,  Gel, AP,  true,  true,  true,  6982),
            ...
            T("720.001",      "720",   "Brüt Ücretler",                          Sub,  Mal, Act, false, false, false, 7201),
            T("720.001.001",  "720.001","Brüt Ücretler",                          Det,  Mal, Act, false, true,  false, 7202),
            ...
            T("770.001",      "770",   "Personel Giderleri",                     Sub,  Mal, Act, true,  false, false, 7701),
            T("770.001.001",  "770.001","Personel Giderleri",                     Det,  Mal, Act, true,  true,  false, 7702),
            T("770.002",      "770",   "Kira Giderleri",                         Sub,  Mal, Act, true,  false, false, 7703),
            T("770.002.001",  "770.002","Kira Giderleri",                         Det,  Mal, Act, true,  true,  false, 7704),
            T("770.003",      "770",   "Elektrik Su Gaz Giderleri",              Sub,  Mal, Act, true,  false, false, 7705),
            T("770.003.001",  "770.003","Elektrik Su Gaz Giderleri",              Det,  Mal, Act, true,  true,  false, 7706),
            T("771",         null,    "Genel Yönetim Giderleri Yansıtma",       Main, Mal, Pas, true,  false, false, 7710),
            T("771.001",      "771",   "Genel Yönetim Giderleri Yansıtma",       Sub,  Mal, Pas, true,  false, false, 7711),
            T("771.001.001",  "771.001","Genel Yönetim Giderleri Yansıtma",       Det,  Mal, Pas, true,  true,  false, 7712),
            T("780",         null,    "Finansman Giderleri",                    Main, Mal, Act, true,  false, true,  7800),
            T("780.001",      "780",   "Kısa Vadeli Finansman Giderleri",        Sub,  Mal, Act, true,  false, true,  7801),
            T("780.001.001",  "780.001","Kısa Vadeli Finansman Giderleri",        Det,  Mal, Act, true,  true,  true,  7802),
            ...
            T("900.001",      "900",   "Alınan Teminat Mektupları",              Sub,  Naz, Act, false, false, false, 9001),
            T("900.001.001",  "900.001","Alınan Teminat Mektupları",              Det,  Naz, Act, false, true,  false, 9002),
            T("901",         null,    "Teminat Mektupları Karşılığı",           Main, Naz, Pas, false, false, false, 9010),
            T("901.001",      "901",   "Alınan Teminat Mektupları Karşılığı",    Sub,  Naz, Pas, false, false, false, 9011),
            T("901.001.001",  "901.001","Alınan Teminat Mektupları Karşılığı",    Det,  Naz, Pas, false, true,  false, 9012),
    ...
    [
        ...
        new BudgetTypeMetadata
        {
            ...
            BaseReceivableCode = "120.002",
            BaseIncomeCode = "600.002",
        ...
        new BudgetTypeMetadata
        {
            ...
            BaseReceivableCode = "120.003",
            BaseIncomeCode = "600.003",
            DefaultPaymentSchedule = PaymentSchedule.Installment,
            AllowMultiplePerYear = true,
            DisplayOrder = 3,
            IsActive = true,
        ...
        new BudgetTypeMetadata
        {
            ...
            BaseReceivableCode = "120.004",
            BaseIncomeCode = "600.004",
            DefaultPaymentSchedule = PaymentSchedule.Installment,
            AllowMultiplePerYear = true,
            DisplayOrder = 4,
            IsActive = true,
