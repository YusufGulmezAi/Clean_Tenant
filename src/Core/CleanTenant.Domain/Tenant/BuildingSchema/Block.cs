...
/// (Site) bünyesinde tanımlanır; her site'nin en az bir Block'u olmalıdır.
/// </para>
/// <para>
...
public sealed class Block : BaseEntity, IAggregateRoot, IHasUrlCode, ITenantScoped
{
    ...
    /// <summary>Bu Block'un ait olduğu Site (Company).</summary>
    ...
    /// <summary>Bu Block'un ait olduğu Site (navigation property).</summary>
    public Company Company { get; set; } = null!;
    /// <summary>Bu Block altında tanımlı parseller (navigation property).</summary>
