...
/// <summary>
/// <see cref="UpdateBankAccountCommand"/> FluentValidation kuralları.
/// </summary>
public sealed class UpdateBankAccountCommandValidator : AbstractValidator<UpdateBankAccountCommand>
{
    /// <summary>DI bağımlılıklarını alır.</summary>
    public UpdateBankAccountCommandValidator(IStringLocalizer localizer)
    {
        RuleFor(x => x.BankAccountId)
            .NotEmpty().WithMessage(_ => localizer["Validation.Required", "BankAccountId"].Value);
