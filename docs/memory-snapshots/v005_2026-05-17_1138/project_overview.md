...
## Applications
- **ManagementApp** — Blazor + Razor Components. Admin/operator panel. Used by system admins, tenant admins, company staff, building managers. Hierarchy: System → Tenant → Company → Building/Block.
