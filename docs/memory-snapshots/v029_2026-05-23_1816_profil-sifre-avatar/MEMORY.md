...
- [Form Açıklama Bloğu](feedback_form_aciklama_blogu.md) — Her form sayfasında üstte açıklama bloğu (alan bilgisi + mantık + ilişkili formlar); kullanıcı onayladıktan sonra gizlenir
...
- [Object Storage + Profil Sayfası](project_object_storage.md) — v0.2.13: IFileStorage/IImageProcessor (MinIO+SkiaSharp) + /profile (foto, 2FA recovery 10→12, dil); WebApi integration suite pre-existing kırık
